	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header class="entry-header">
			<hgroup>
				...
				<h3 class="entry-format"><?php _e( 'Quote', 'flexopotamus' ); ?></h3>
			</hgroup>
			...
			<div class="comments-link">
				<?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply', 'flexopotamus' ) . '</span>', _x( '1', 'comments number', 'flexopotamus' ), _x( '%', 'comments number', 'flexopotamus' ) ); ?>t
			</div>
			<?php endif; ?>
		</header><!-- .entry-header -->
