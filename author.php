		...
		<section id="primary">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'flexopotamus' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
				</header>
				...
				<?php flexopotamus_content_nav( 'nav-above' ); ?>
				...
				<div id="author-info">
					...
					<div id="author-description">
						<h2><?php printf( __( 'About %s', 'flexopotamus' ), get_the_author() ); ?></h2>
