...
<?php if ( have_posts() ) : ?>
				<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'flexopotamus' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php
...
<?php else : ?>
				<div id="post-0" class="post no-results not-found">
					<h2 class="entry-title"><?php _e( 'Nothing Found', 'flexopotamus' ); ?></h2>
